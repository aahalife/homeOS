...
**Your Family AI Assistant** — Powered by [Osaurus](https://github.com/dinoki-ai/osaurus)

Oi My AI brings AI-powered Skills to help manage your family's daily life — from meal planning to appointment scheduling — running locally on Apple Silicon with privacy-first design.

**[Documentation](https://docs.oimyai.app/)** · **[Contributing](docs/CONTRIBUTING.md)**
...
Oi My AI is your family AI assistant built on the Osaurus runtime. It brings together:
...
Launch Oi My AI from Spotlight or run:
...
Oi My AI is a full MCP (Model Context Protocol) server. Connect it to any MCP client to give AI agents access to your installed tools.
...
Connect to external MCP servers and aggregate their tools into Oi My AI:
...
Point any OpenAI-compatible client at Oi My AI:
...
**We're looking for contributors!** Oi My AI is actively developed and we welcome help in many areas:
...
If you find Oi My AI useful, please star the repo and share it!
